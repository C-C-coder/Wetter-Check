...
# WICHTIG: Wir setzen die Umgebungsvariable, die dem Google-Client 
# den exakten Namen der Standard-Datenbank ohne URL-Kodierung aufzwingt.
os.environ["FIRESTORE_DATABASE"] = "(default)"

# Jetzt greift der Client absolut sauber auf die (default) Datenbank zu
db = firestore.client()
