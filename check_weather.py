...
#  Abstieg zurueck zum Ausgangspunkt, verschieben sich die Zonen-ZEITEN
...
# ==============================================================================
SEGMENT_NAMES_ELEV = ["Ausgangspunkt", "Unterer Teil", "Mittlerer Teil", "Oberer Teil", "Gipfel"]
...
# Ausgangspunkt"/"im Gipfel" sind falsch (richtig: "am ..."), "im Unterer Teil" fehlt
# sogar die Deklination (richtig: "im unteren Teil"). Deshalb Praeposition + Form
# pro Basisname fest hinterlegt statt "im " pauschal voranzustellen.
SEGMENT_PRAEP_FORM = {
    "Ausgangspunkt": "am Ausgangspunkt",
...
def analyze_segment_hazards(segmente, now, end_dt, tour_types):
    ...
    z.B. neu einsetzenden Regen am Ausgangspunkt komplett aus, sobald die
...
def build_segment_alert(segmente, niederschlag, gefahren, start_dt, duration_h,
    ...
    durchschritten"). Damit wurde z.B. neu einsetzender Regen am Ausgangspunkt
