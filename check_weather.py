...
if not firebase_admin._apps:
    ...
    if cred_json:
        ...
        # Hier wird die Standard-Datenbank explizit im Konfigurations-Dictionary übergeben,
        # was von allen Client-Versionen fehlerfrei verstanden wird.
        firebase_admin.initialize_app(cred, {
            'projectId': cred_dict.get('project_id'),
            'databaseURL': f"https://{cred_dict.get('project_id')}-default-rtdb.europe-west1.firebasedatabase.app"
        })
    else:
        firebase_admin.initialize_app()

# Ganz normaler Client-Aufruf ohne den nicht unterstützten 'database'-Parameter
db = firestore.client()
