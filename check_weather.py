...
def send_high_priority_push(title, body, token):
  ...
  msg = messaging.Message(
      ...
      android=messaging.AndroidConfig(
          priority='high',
          ttl=timedelta(hours=2) # Verhindert, dass uralte Warnungen nach einem langen Funkloch ankommen
      ),
      webpush=messaging.WebpushConfig(
          headers={'Urgency': 'high'},
          notification=messaging.WebpushNotification(
              require_interaction=True,          # Bleibt auf dem Display kleben!
              vibrate=[200, 100, 200, 100, 400]  # Alarm-Vibration
          )
      )
  )
  ...
  for doc in docs:
      ...
      try:
          ...
          if start_dt <= now <= end_dt:
              ...
              # BLOCK 1: Gefahren-Warnung senden (MIT LOGGING)
              ...
              # BLOCK 2: Stündliches Update senden (MIT LOGGING)
