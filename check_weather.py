...
def check_all_tours():
   ...
   print(f"DEBUG: Aktuelle UTC-Zeit auf GitHub: {now.isoformat()}")
   ...
   for doc in docs:
       ...
       if not token or not lat or not lon or not start_time_str:
           print(f"DEBUG: Tour übersprungen wegen fehlender Pflichtfelder (Token/Lat/Lon/Start).")
           continue
       ...
       try:
           ...
           print(f"DEBUG: Tour-Zeitfenster UTC: {start_dt.isoformat()} bis {end_dt.isoformat()} | Now: {now.isoformat()}")
