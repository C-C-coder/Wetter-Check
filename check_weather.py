...
def check_forecast_trend(lat, lon, start_dt, duration, tour_types=None, peak_lat=None, peak_lon=None):
   ...
   try:
       ...
       url = f"https://api.open-meteo.com/v1/forecast?latitude={lat}&longitude={lon}&hourly=temperature_2m,precipitation,snowfall,weather_code,precipitation_probability,wind_gusts_10m,cape,visibility&start_date={date_str}&end_date={end_date_str}&timezone=auto&wind_speed_unit=kmh&models=best_match"
       ...
       ph = {}
       if peak_lat and peak_lon:
           p_url = f"https://api.open-meteo.com/v1/forecast?latitude={peak_lat}&longitude={peak_lon}&hourly=temperature_2m,precipitation,snowfall,weather_code,precipitation_probability,wind_gusts_10m,cape,visibility&start_date={date_str}&end_date={end_date_str}&timezone=auto&wind_speed_unit=kmh&models=best_match"
