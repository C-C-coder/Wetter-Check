...
# Firebase App sauber initialisieren und Projekt-ID aus dem Secret auslesen
...
db = firestore.client()
# Erzwingt den exakten Standard-Datenbankpfad im Client, um URL-Kodierungsfehler (%28default%29) gänzlich zu verhindern
try:
   db._database_string = f"projects/{db.project}/databases/(default)"
except Exception:
   pass
